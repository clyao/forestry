...
import com.forestry.core.support.BaseParameter;
...
public class BaseDao<E> implements Dao<E> {
	...
	protected Map handlerConditions(BaseParameter param) throws Exception {
		Map staticConditions = com.forestry.core.util.BeanUtils.describe(param);
	...
	private void processQuery(Criteria criteria, BaseParameter param) {
		try {
			Map<String, Object> staticConditionMap = com.forestry.core.util.BeanUtils.describeAvailableParameter(param);
